...
import com.halo.lock.annotation.ReadLock;
...
public class ReadLockAspect {
    ...
    @Pointcut("@annotation(com.halo.lock.annotation.ReadLock)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        //获取Lock注解及注解参数
        final ReadLock lock = method.getAnnotation(ReadLock.class);
        ...
        //尝试加锁，超时时间为waiteTime
        boolean b = readLock.tryLock(waiteTime, TimeUnit.SECONDS);
        ...
        if (b) {
            ...
            throw new RuntimeException("try read lock failed!");
        }
    }
}
