...
import com.halo.lock.annotation.Lock;
...
public class LockAspect {
    ...
    @Pointcut("@annotation(com.halo.lock.annotation.Lock)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        //以类名+方法名+参数值作为锁的key
        String redisKey = point.getTarget().getClass().getName() + ":" + method.getName();
        ...
        //尝试加锁，超时时间为waiteTime
        boolean b = rLock.tryLock(waiteTime, TimeUnit.SECONDS);
